...
public class BridgePattern {
    ...
    BridgePattern() {
        ...
        JLabel vegLabel = new JLabel("Veg Dish: " + vegDish1.getDishName() + " Rs 950");
        ...
        vegDish2.dish("Daal Makhni");
        JLabel vegLabel2 = new JLabel("Veg Dish: " + vegDish2.getDishName() + " Rs 950");
        ...
        vegDish3.dish("Daal Makhni");
        JLabel vegLabel3 = new JLabel("Veg Dish: " + vegDish3.getDishName() + " Rs 950");
        ...
        vegDish4.dish("Daal Makhni");
        JLabel vegLabel4 = new JLabel("Veg Dish: " + vegDish4.getDishName() + " Rs 950");
        ...
        JLabel nonVegLabel = new JLabel("NonVeg Dish: " + nonVegDish.getDishName() + " Rs 1250");
        ...
        nonVegDish2.dish("Chicken Handi");
        JLabel nonVegLabel2 = new JLabel("NonVeg Dish: " + nonVegDish2.getDishName() + " Rs 1250");
        ...
        nonVegDish3.dish("Chicken Handi");
        JLabel nonVegLabel3 = new JLabel("NonVeg Dish: " + nonVegDish3.getDishName() + " Rs 1250");
        ...
        nonVegDish4.dish("Chicken Handi");
        JLabel nonVegLabel4 = new JLabel("NonVeg Dish: " + nonVegDish.getDishName() + " Rs 1250");
